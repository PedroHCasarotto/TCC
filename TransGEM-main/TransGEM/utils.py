...
parser.add_argument("--decimal_points", type=int, default=6, help="Number of decimal points used in gene expression")
parser.add_argument("--gene_e_length", type=int, default=978, help="Number of gene expressions")
parser.add_argument("--max_int", type=int, default=0, help="Maximum int number that exists in the gene expression")

parser.add_argument("--cell_types_length", type=int, default=2, help="Number of cell_types in the dataset")
