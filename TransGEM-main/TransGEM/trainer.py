...
class Trainer():
    ...
    def train(self):
        floder = self.args.out_path+"ckpts_{}/decimal_points_{}/{}/maxint{}_genelength{}_dim{}_n{}h{}ff{}_bh{}_lr{}".format(
            self.args.dataset,self.args.decimal_points,self.args.gene_encoder, 
            self.args.max_int, self.args.gene_e_length, self.args.hidden_dim,
            self.args.TF_N, self.args.TF_H, self.args.ff_dim,
            self.args.batch_size, self.args.lr
            )
       
        if not os.path.exists(floder):
            os.makedirs(floder)

        self.log('Training start({}_decimal_points{}_encoder{}_maxint{}_genelength{}_dim{}_n{}h{}ff{}_bh{}_lr{}'.format(
            self.args.dataset, self.args.decimal_points, self.args.gene_encoder,
            self.args.max_int, self.args.gene_e_length, self.args.hidden_dim,
            self.args.TF_N,self.args.TF_H,self.args.ff_dim,self.args.batch_size,self.args.lr))
    ...
    def save_model_and_records(self, epoch, final_save=False):
        ...
        with open(self.args.out_path+"ckpts_{}/decimal_points_{}/{}/maxint{}_genelength{}_dim{}_n{}h{}ff{}_bh{}_lr{}/best_weights".format(
            self.args.dataset,self.args.decimal_points,self.args.gene_encoder, 
            self.args.max_int, self.args.gene_e_length, self.args.hidden_dim,
            self.args.TF_N, self.args.TF_H, self.args.ff_dim,
            self.args.batch_size, self.args.lr), 'wb') as f:
    ...
    def save_loss_records(self):
        if not os.path.exists(self.args.out_path+"ckpts_{}/decimal_points_{}/{}/recoders".format(
            self.args.dataset,self.args.decimal_points,self.args.gene_encoder)):
            os.makedirs(self.args.out_path+"ckpts_{}/decimal_points_{}/{}/recoders".format(self.args.dataset,self.args.decimal_points,self.args.gene_encoder))
        ...
        ret.to_csv(self.args.out_path+'ckpts_{}/decimal_points_{}/{}/recoders/record_maxint{}_genelength{}_dim{}_n{}h{}ff{}_bh{}_lr{}.csv'.format(
            self.args.dataset,self.args.decimal_points,self.args.gene_encoder,
            self.args.max_int, self.args.gene_e_length,self.args.hidden_dim,
            self.args.TF_N,self.args.TF_H,self.args.ff_dim,
            self.args.batch_size,self.args.lr), index=False)
        return ret
    ...
    def log(self, msg=None, msgs=None, with_time=False, show=True):
        ...
        if not os.path.exists(self.args.out_path+"ckpts_{}/decimal_points_{}/{}/log".format(
            self.args.dataset,self.args.decimal_points,self.args.gene_encoder)):
            os.makedirs(self.args.out_path+"ckpts_{}/decimal_points_{}/{}/log".format(
                self.args.dataset,self.args.decimal_points,self.args.gene_encoder))
        with open(self.args.out_path+'ckpts_{}/decimal_points_{}/{}/log/log_maxint{}_genelength{}_dim{}_n{}h{}ff{}_bh{}_lr{}.txt'.format(
            self.args.dataset,self.args.decimal_points,self.args.gene_encoder,
            self.args.max_int, self.args.gene_e_length,self.args.hidden_dim,
            self.args.TF_N,self.args.TF_H,self.args.ff_dim,
            self.args.batch_size,self.args.lr), 'a+') as f:
            if msgs:
                self.log('#' * 80)
